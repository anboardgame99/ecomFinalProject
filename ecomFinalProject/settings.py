"""
Django settings for ecomFinalProject project.
...
ALLOWED_HOSTS = ['localhost','127.0.0.1','https://andug-ecommerce-50a083fc8ec0.herokuapp.com/']
...
ROOT_URLCONF = 'ecomFinalProject.urls'
